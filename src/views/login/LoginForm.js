              ...
              <CRow className="mt-4 align-items-center">
                ...
                <CCol lg="8">
                  <CInputGroup>
                    ...
                    <CInput className="login-input" placeholder='Enter User Code' type='text' autoFocus
                      value={userCode} onChange={userCodeChange} onKeyDown={downKey}></CInput>
                  </CInputGroup>
                </CCol>
              </CRow>
                ...
                <CCol lg="8">
                  <CInputGroup>
                    ...
                    <CInput className="login-input" placeholder='Enter Password' type='password'
                      value={password} onChange={passwordChange} onKeyDown={downKey}></CInput>
                  </CInputGroup>
                </CCol>
              </CRow>
              <br></br>
