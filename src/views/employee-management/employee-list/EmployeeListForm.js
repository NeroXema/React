...
function EmployeeListForm(props) {
  let { userName, userNameChange, genderData, selectGender, selectGenderChange, searchClick, employeeList, total, currentPage, lastPage, pagination, editClick, delClick } = props;
  return (
    <div className='mt-4'>
